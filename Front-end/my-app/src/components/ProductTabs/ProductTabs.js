...
const ProductTabs = () => {
  ...
  const loadProducts = async () => {
    setLoading(true)
    try {
      const res1 = await productApi.getProductHome(15) 
      const res2 = await productApi.getProductHome(10)
      const res3 = await productApi.getProductHome(7) 

      setTab1Data(res1.data)
      setTab2Data(res2.data)
      setTab3Data(res3.data)
    } catch (error) {
